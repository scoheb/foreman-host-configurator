            ...
            if (csv) {
                try {
                    for (CSVRecord record :
                        ...
                        host.addParameter(new Parameter(HostTypeAdapter.parameterMapping.get("labels"), record.get(1)));
                        host.addParameter(new Parameter(HostTypeAdapter.parameterMapping.get("remoteFs"), record.get(2)));
